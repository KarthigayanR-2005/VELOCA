...
// postAnnotation drops a marker on the Grafana timeline for a fault
// injection. A failure here (e.g. Grafana not reachable) is logged and
// swallowed — annotating the dashboard is a nice-to-have, not the fault
// injection itself.
